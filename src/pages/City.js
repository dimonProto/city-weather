    ...
    return (
        <div className={'detailBlock'}>
            ...
            <div className={'hourBlock'}>
                {currentCity.weatherByHours.hourly.map((item, idx) => {
                    return (
                        <div
                            key={idx}
                            className={'cardHour'}
                            style={{ marginTop: calculateMargin(Math.round(item.temp)) }}>
